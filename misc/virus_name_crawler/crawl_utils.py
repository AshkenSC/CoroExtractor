...
def get_html_with_header(url, code='utf-8', header=None):
    ...
    headers = {'User-Agent': 'Mozilla/5.0 (Windows; U; Windows NT 5.1; pt-BR) AppleWebKit/533.3 ', }
    headers = {'User-Agent': '(KHTML, like Gecko)  QtWeb Internet Browser/3.7 http://www.QtWeb.net', }
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) ', }
    headers = {'User-Agent': 'Chrome/41.0.2228.0 Safari/537.36', }
    # headers = {'User-Agent': 'Mozilla/5.0 (Future Star Technologies Corp.; Star-Blade OS; x86_64; U; ', }
    if header:
        headers = header
